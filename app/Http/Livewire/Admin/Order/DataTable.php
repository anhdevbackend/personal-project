...
class DataTable extends Component
{
    ...
    public function getModelProperty($paginate = true)
    {
        ...
        $this->deliveredOnFrom != ''
            ? $qry->where('delivered_on', '>=', $this->deliveredOnFrom . ' 00:00:00') : '';
        '' != $this->deliveredOnTo ? $qry->where('delivered_on', '<=', $this->addedOnTo . ' 23:59:59') : '';
        '' != $this->cancelOnFrom ? $qry->where('cancel_on', '>=', $this->cancelOnFrom . ' 00:00:00') : '';
        '' != $this->cancelOnTo ? $qry->where('cancel_on', '<=', $this->cancelOnTo . ' 23:59:59') : '';
